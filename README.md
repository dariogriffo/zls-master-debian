...
📖 **Step-by-step install guide:** [Debian](https://debian.griffo.io/install-latest-zls-in-debian.html) · [Ubuntu](https://debian.griffo.io/install-latest-zls-in-ubuntu.html)
